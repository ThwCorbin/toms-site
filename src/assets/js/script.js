...
//> Workaround for prismjs, which is not working using npm packages
/* PrismJS 1.17.1
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+javascript+bash+markdown+yaml+regex */
var _self =
